    ...
    return (
        <>
            <SEO
                ...
                image="https://www.groundedminds.ca/headshotdanielle.png"
                imageAlt="Danielle Kirshenbaum, therapist specialized in anxiety, OCD, Perinatal mental health and psychosis."
            />
            <div>
            ...
            <section id="aboutBannermid">
                <div className="mb40 mt40 raise">
                    <a className="booknow caps" href="https://groundedmindstherapy.janeapp.com/#/staff_member/6" id="about-banner-cta" target="_blank" rel="noopener noreferrer">Book with Danielle</a>
                </div>
            </section>
            <br />
        </>
