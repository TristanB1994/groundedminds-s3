                    ...
                    <div className="pb30" id="consult">
                        ...
                        <div className="pb30" id="consult">
                            ...
                            <p className="pb10 aaa">
                                ...
                                <br /><br />
                                Angie Blandford and Neena Malhotra aretrained CPT provider. Lianne offers Eye Movement Desensitization and Reprocessing (EMDR) Therapy for PTSD. All of our therapists use trauma-informed practices to support you in healing from difficult experiences. During the assessment, you and your therapist will talk about what approach is the best fit for you.
                            </p>
                            <br />
                            <a className="booknow" href="https://groundedmindstherapy.janeapp.com/" target="_blank" rel="noopener noreferrer">
                                ONLINE BOOKING
