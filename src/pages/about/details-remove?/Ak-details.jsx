        ...
        <>
            <section className="content">
                <div className="portrait">
                    <img alt="Therapist picture" id="AK-SECTION" src="/anka.jpeg" />
                    <div className="ownertexts">
                        <p className="fancy">
                            <br />Anka Krivokuca<span id="bigabout"><br /> </span>
                        </p>
                        <p id="ownertext">pronouns: she/her<br /><br />MSW, RSW</p>
                    </div>
                </div>
                <br />
                <p className="pb10 aaa">
                    My goal is to provide a space where you can feel seen, heard and understood. Together, we will explore your symptoms and help you make sense of them. I'll introduce you to a variety of coping strategies that you can use in moments of anxiety as well as your day to day life. <br /><br /> Anxiety and OCD symptoms are awful, but you don't have to go through them alone. Over time, the tools you learn in therapy can help you feel more confident and less afraid. I love being a therapist because I get to help people <i>just like you</i> learn how to manage distressing emotions like anxiety.
                </p>
            </section>
            <section className="content">
            ...
            <section className="content">
                <div>
                    ...
                    <p className="pb10 aaa">
                        I am a Registered Social Worker (RSW) with the <br /> Ontario College of Social Workers and Social Service Workers (OCSWSSW).
                    </p>
                    <p className="pb10 aaa">
                    ...
                    <p className="deets">
                        <a href="mailto:angie@groundedminds.ca">angie@groundedminds.ca</a> <br /><a href="tel:2892126486">289-212-6486</a>
                    </p>
                </div>
                <br />
            </section>
