                        ...
                        <div className="pb30" id="consult">
                            ...
                            <div className="pb30" id="consult">
                                ...
                                <p className="pb10 aaa">
                                    ...
                                    <br /><br />
                                    Anka Krivokuca and Angie Blandford are trained CPT providers. Anka also offers Prolonged Exposure (PE) Therapy for PTSD and Lianne offers Eye Movement Desensitization and Reprocessing (EMDR) Therapy for PTSD. All of our therapists use trauma-informed practices to support you in healing from difficult experiences. During the assessment, you and your therapist will talk about what approach is the best fit for you.
                                </p>
                                <br />
                                <a className="booknow" href="https://groundedmindstherapy.janeapp.com/" target="blank">
                                    ONLINE BOOKING
